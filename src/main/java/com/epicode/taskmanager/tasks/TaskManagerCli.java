...
public final class TaskManagerCli {
    ...
    private void createGroup() {
        final OperationResult<String> result = shield.execute(() -> {
            final String parentId = ask("Parent group id");
            final String title = ask("Group title");
            final String description = ask("Group description");
    ...
    private void createTask() {
        final OperationResult<String> result = shield.execute(() -> {
            final String parentId = ask("Parent group id");
            final String title = ask("Task title");
            final String description = ask("Task description");
            final Priority priority = parsePriority(ask("Priority (LOW, MEDIUM, HIGH)"));
            final LocalDate dueDate = parseDate(ask("Due date (YYYY-MM-DD)"));
    ...
    private void markCompleted() {
        final OperationResult<String> result = shield.execute(() -> {
            final String componentId = ask("Task or group id");
    ...
    private void save() {
        final OperationResult<String> result = shield.execute(() -> {
            final String filePath = ask("XML file path");
